...
export function SidebarLayoutTablet({
  data,
  monthlyData,
  visible,
  expanded,
  ...
  return (
    <div className="w-full h-full grid grid-cols-2 grid-rows-[2fr_1fr_1fr] gap-4">
      {/* MAP CONTAINER - Tablet: Top Full Width */}
      <div className="relative w-full bg-white/5 border border-white/10 rounded-sm overflow-hidden group col-span-2 row-span-1 h-full block">
        {/* Map Area */}
        <div className="relative flex-1 w-full h-full">
          ...
          {/* KPI CARDS - DESKTOP/TABLET (Overlay) */}
      ...
      {/* REGIONS - Tablet: Row 2, Col 1 */}
      <div className="col-span-1 row-span-1 flex flex-col min-h-0 h-full">
      ...
      {/* EVENT TYPES (Donut) - Tablet: Row 2, Col 2 */}
      <div className="relative w-full bg-white/5 border border-white/10 rounded-sm flex flex-col col-span-1 h-full">
        <h4
      ...
      {/* RISK PROFILE (Spider Chart) - Tablet: Row 3, Col 1 */}
      {hasRiskProfile ? (
        <div className="relative w-full bg-white/5 border border-white/10 rounded-sm col-span-1 h-full">
          <h4
      ...
      {/* INCIDENT TIMELINE (Beeswarm) - Tablet: Row 3, Col 2 (or Col 1-2 if no Risk Profile) */}
      <div
        className={`${
          hasRiskProfile ? "col-span-1" : "col-span-2"
        } relative w-full bg-white/5 border border-white/10 rounded-sm overflow-hidden h-full`}
      >
        <h4
          className={`absolute top-2 left-3 z-10 text-[#ff9a65] text-[10px] uppercase pointer-events-none ${geistMono.className}`}
        >

      ...
      >
        ...
        <section className="w-full min-h-screen flex flex-col justify-center snap-start px-6 md:px-12 lg:px-12 xl:px-20 pt-24 pb-12 md:py-16 lg:py-20 xl:py-24 max-w-[1600px] mx-auto relative">
          <div className="w-full">
            <h1
              className={`text-white/60 ${n27.className} text-3xl md:text-4xl lg:text-5xl leading-[0.8] tracking-tighter mb-8 uppercase`}
            >
              [data sources]
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
              <div className="md:col-span-6">
                <p
                  className={`font-light ${geistMono.className} text-lg md:text-xl lg:text-2xl text-white/80 leading-relaxed`}
                >
          ...
          <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-12 xl:px-20 pb-12 pt-4 md:py-16 lg:py-20 xl:py-24">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-12 xl:gap-24">
              ...
              <div className="lg:col-span-4 flex flex-col justify-center lg:justify-between lg:h-[60vh]">
                <div>
                  <h2
                    className={`${n27.className} text-5xl md:text-7xl lg:text-8xl xl:text-9xl text-purple-400 mb-6 leading-none`}
                  >
                    UCDP
                  </h2>
                  <span
                    className={`${geistMono.className} text-[10px] uppercase border border-white/20 px-3 py-1.5 text-white/50 tracking-wider`}
                  >
                    Academic / Research
                  </span>
                </div>
                <div className="hidden lg:block mt-auto">
                  ...
                  <span
                    className={`${geistMono.className} text-xs text-purple-400 uppercase tracking-widest`}
                  >
                    Global Standard
                  </span>
                </div>
              ...
              <div className="lg:col-span-8 space-y-12 flex flex-col justify-center">
                <div className="space-y-8">
                  <h3
                    className={`${n27.className} text-3xl md:text-4xl lg:text-4xl xl:text-5xl text-white font-light`}
                  >
                    Uppsala Conflict Data Program
                  </h3>
                  <CollapsibleDescription>
                    <p
                      className={`${geistMono.className} text-white/60 leading-relaxed text-sm md:text-base lg:text-lg max-w-4xl`}
                    >
                    ...
                    <p
                      className={`${geistMono.className} text-white/60 leading-relaxed text-sm md:text-base lg:text-lg max-w-4xl mt-4`}
                    >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-4 xl:gap-12 border-t border-white/10 pt-12">
                  <div>
                    <span
                      className={`block text-[#ff9a65] ${geistMono.className} text-[10px] uppercase mb-2 tracking-widest`}
                    >
                      Coverage
                    </span>
                    <span
                      className={`${geistMono.className} text-lg md:text-xl lg:text-xl xl:text-2xl`}
                    >
                      Global
                    </span>
                ...
                <div className="pt-8">
                  <Link
                    ...
                    target="_blank"
                    className={`inline-flex items-center gap-3 text-base md:text-lg lg:text-xl ${geistMono.className} uppercase tracking-widest hover:text-[#ff9a65] transition-colors group/link`}
                  >
                    Access Database{" "}
          ...
          <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-12 xl:px-20 py-12 md:py-16 lg:py-20 xl:py-24">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-12 xl:gap-24">
              ...
              <div className="lg:col-span-4 flex flex-col justify-center lg:justify-between lg:h-[60vh]">
                <div>
                  <h2
                    className={`${n27.className} text-5xl md:text-7xl lg:text-8xl xl:text-9xl text-blue-400 mb-6 leading-none`}
                  >
                    ACLED
                  </h2>
                  <span
                ...
                <div className="hidden lg:block mt-auto">
                  ...
                  <span
                    className={`${geistMono.className} text-xs text-blue-400 uppercase tracking-widest`}
                  >
                    Real-time Mapping
                  </span>
                </div>
              ...
              <div className="lg:col-span-8 space-y-12 flex flex-col justify-center">
                <div className="space-y-8">
                  <h3
                    className={`text-3xl md:text-4xl lg:text-5xl ${n27.className} text-white font-light`}
                  >
          ...
          <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-12 xl:px-20 py-12 md:py-16 lg:py-20 xl:py-24">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-12 xl:gap-24">
              ...
              <div className="lg:col-span-4 flex flex-col justify-center lg:justify-between lg:h-[60vh]">
                <div>
                  <h2
                    className={`${n27.className} text-5xl md:text-7xl lg:text-8xl xl:text-9xl text-yellow-500 mb-6 leading-none`}
                  >
                    AWSD
                  </h2>
                  <span
                ...
                <div className="hidden lg:block mt-auto">
                  ...
                  <span
                    className={`${geistMono.className} text-xs text-yellow-500 uppercase tracking-widest`}
                  >
                    Ground Truth
                  </span>
                </div>
          ...
          <div className="w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-12 xl:px-20 py-12 md:py-16 lg:py-20 xl:py-24">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-12 xl:gap-24">
              ...
              <div className="lg:col-span-4 flex flex-col justify-center lg:justify-between lg:h-[60vh]">
                <div>
                  <h2
                    className={`${n27.className} text-4xl md:text-6xl lg:text-7xl xl:text-8xl text-emerald-400 mb-6 leading-none wrap-break-word`}
                  >
                    REST
                    <br />
                    COUNTRIES
                ...
                <div className="hidden lg:block mt-auto">
                  ...
                  <span
                    className={`${geistMono.className} text-xs text-emerald-400 uppercase tracking-widest`}
                  >
        ...
        <section className="w-full bg-black border-t border-white/10 px-6 py-12 relative snap-start">
          <div className="max-w-[1600px] mx-auto w-full text-center">
            <p
              className={`${geistMono.className} text-[10px] text-white/30 uppercase tracking-widest mb-4`}
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-2 text-left max-w-4xl mx-auto">
              <a
                ...
                className={`${geistMono.className} text-[9px] text-white/20 hover:text-white/50 transition-colors block truncate`}
              >

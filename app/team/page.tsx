      ...
      <main ref={mainRef} className="flex-1 overflow-y-auto relative z-10 custom-scrollbar snap-y snap-mandatory scroll-smooth">
        ...
        <section className="w-full min-h-screen flex flex-col pt-40 pb-20 snap-start px-6 md:px-16 max-w-[1600px] mx-auto relative">
            <div className="w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
                    <div className="lg:col-span-8">
                        ...
                        <p className="font-[family-name:var(--font-geist-mono)] text-xl md:text-2xl text-white/80 leading-relaxed max-w-2xl font-light">
                            A collaborative effort by three students leveraging Open Data to visualize and decode the complexity of global conflict. Built as a term project to demonstrate the power of public information.
                        </p>
                    </div>
                ...
                <div className="mt-24 text-white/30 hidden md:block">
                    <span className="font-mono text-[10px] uppercase tracking-widest">Meet the Students</span>
        ...
        <section className="w-full min-h-screen flex items-center snap-start bg-black relative border-t border-white/10 overflow-hidden">
             ...
             <div className="w-full max-w-[1600px] mx-auto px-6 md:px-20 py-20 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    {/* Kevin Forter */}
                    <div className="group relative border border-white/10 bg-white/5 p-8 transition-colors duration-500">
                        ...
                        <h3 className="font-[n27] text-2xl mb-1 transition-colors">Kevin Forter</h3>
                        <p className="font-mono text-xs uppercase tracking-widest text-white/50 mb-4">Informatik / Computer Science</p>
                    </div>
                    ...
                    {/* Luca Bachmann */}
                     <div className="group relative border border-white/10 bg-white/5 p-8 transition-colors duration-500">
                        ...
                        <h3 className="font-[n27] text-2xl mb-1 transition-colors">Luca Bachmann</h3>
                        <p className="font-mono text-xs uppercase tracking-widest text-white/50 mb-4">Wirtschaftsinformatik</p>
                    </div>
                    ...
                    {/* Xuan Ming Feng */}
                     <div className="group relative border border-white/10 bg-white/5 p-8 transition-colors duration-500">
                        ...
                        <h3 className="font-[n27] text-2xl mb-1 transition-colors">Xuan Ming Feng</h3>
                        <p className="font-mono text-xs uppercase tracking-widest text-white/50 mb-4">Biomedical Engineering</p>
                    </div>
        ...
        <section className="w-full min-h-screen flex flex-col justify-center snap-start bg-black border-t border-white/10 relative overflow-hidden">
             <div className="w-full max-w-[1600px] mx-auto px-6 md:px-20 py-20 relative z-10 text-center">
                 <span className="block text-white/40 font-mono text-xs uppercase tracking-widest mb-6">Course Project</span>
                 <h2 className="font-[n27] text-5xl md:text-8xl text-white mb-12 leading-[0.85]">
                    UNIVERSITY<br/>INITIATIVE
                </h2>
                
                <p className="font-[family-name:var(--font-geist-mono)] text-white/60 text-base md:text-lg max-w-2xl mx-auto mb-16">
                    This dashboard was developed as a semester project for the Open Data Application course, transforming raw public data into interactive insights.
                </p>

                <div className="flex flex-col md:flex-row justify-center gap-6">
                    <Link href="/">
                        <BoldCornerButton className="h-12 w-full md:w-auto">Return Home</BoldCornerButton>
                    </Link>

                    <Link href="/dashboard">
                        <div className={`group relative inline-flex h-12 w-full md:w-auto justify-center`}>
                            ...
                            <button
                                className="relative px-8 py-2 border bg-[#ff9a65]/10 border-[#ff9a65] text-white text-sm font-[n27] uppercase tracking-[0.15em] hover:bg-[#ff9a65] transition-colors cursor-pointer z-10 w-full md:w-auto"
                            >
                                Open Dashboard
                            </button>
                        </div>
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden py-10 pointer-events-none opacity-100 z-0">
                 ...
                 <div className="flex whitespace-nowrap animate-marquee w-fit">
                    {Array.from({ length: 20 }).map((_, i) => (
                        <div key={i} className="flex items-center text-xs leading-none font-[n27] text-white/50 uppercase tracking-tighter mr-5">

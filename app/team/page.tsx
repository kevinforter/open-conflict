      ...
      >
          ...
          <div className="w-full max-w-[1600px] mx-auto px-6 md:px-20 py-20 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group relative border border-white/10 bg-white/5 p-8 transition-colors duration-500">
                ...
                <h3 className="font-[n27] text-2xl mb-1 transition-colors">
                  Kevin Forter
                </h3>
                <p className="font-[geistMono] text-xs uppercase tracking-widest text-white/50 mb-4">
        ...
        <section className="w-full min-h-screen flex flex-col justify-center snap-start bg-black border-t border-white/10 relative overflow-hidden">
          <div className="w-full max-w-[1600px] mx-auto px-6 md:px-20 py-20 relative z-10 text-center">
            <span className="block text-white/40 font-[geistMono] text-xs uppercase tracking-widest mb-6">
              Course Project
            </span>
            ...
            <p className="font-[geistMono] text-white/60 text-base md:text-lg max-w-2xl mx-auto mb-16">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-6">
              <Link href="/">
                <BoldCornerButton className="h-12 w-full md:w-auto">
                  Return Home
                </BoldCornerButton>
              </Link>
              ...
              <Link href="/dashboard">
                <div
                  className={`group relative inline-flex h-12 w-full md:w-auto justify-center`}
                >
                  ...
                  <button className="relative px-8 py-2 border bg-[#ff9a65]/10 border-[#ff9a65] text-white text-sm font-[n27] uppercase tracking-[0.15em] hover:bg-[#ff9a65] transition-colors cursor-pointer z-10 w-full md:w-auto">
                    Open Dashboard
                  </button>
                </div>
              </Link>
          ...
          <div className="absolute bottom-0 left-0 w-full overflow-hidden py-10 pointer-events-none opacity-100 z-0">
            ...
            <div className="flex whitespace-nowrap animate-marquee w-fit">
              {Array.from({ length: 20 }).map((_, i) => (
                <div
                  key={i}
                  className="flex items-center text-xs leading-none font-[n27] text-white/50 uppercase tracking-tighter mr-5"
                >

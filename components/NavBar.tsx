...
import BoldCornerButton from "./BoldCornerButton";
      ...
      <div className="hidden md:flex justify-center items-center gap-12 relative">
            ...
            <span className="mr-2 text-white/50 text-sm font-mono uppercase tracking-widest transition-colors cursor-pointer py-4">
             ...
             <span 
                className={cn(
                  ...
                  activeMenu === 'about' || pathname.includes('/about') || pathname.includes('/team') || pathname.includes('/methodology') ? "text-white" : "text-white/50 hover:text-white"
                )}
             >
                About
             </span>
          ...
          >
             <span 
                className={cn(
                  "text-sm font-mono uppercase tracking-widest transition-colors cursor-pointer py-4",
                  activeMenu === 'sources' || pathname.includes('/source') || pathname.includes('/impressum') ? "text-white" : "text-white/50 hover:text-white"
                )}
             >
                Index
             </span>
      ...
      <div className="flex justify-end col-start-3 md:col-auto">
        <Link href="/dashboard">
            <div className="group relative inline-flex h-12">
                ...
                <div
                    className="relative flex items-center px-8 py-2 border bg-[#ff9a65]/10 border-[#ff9a65] text-white text-sm font-[n27] uppercase tracking-[0.15em] hover:bg-[#ff9a65] transition-colors cursor-pointer z-10"
                >
                    Open Dashboard
                </div>
            </div>
       ...
       <div 
            className={cn(
                ...
                activeMenu ? "opacity-100 scale-100 visible" : "opacity-0 scale-95 invisible"
            )}
            ...
            <div className="w-[1000px] flex bg-white/5 shadow-2xl shadow-black/50">
                  ...
                  <>
                    ...
                    >
                        <div className="relative z-10">
                             <span className="block text-white font-mono text-md uppercase tracking-widest mb-2 group-hover/item:text-black transition-colors">[The Project]</span>
                             <h3 className="font-[n27] text-5xl text-white mb-1 group-hover/item:text-[#ff9a65] transition-colors pt-20">Overview</h3>
                             <p className="text-white/40 text-xs font-mono leading-relaxed group-hover/item:text-black transition-colors">
                                Mission, vision, and the challenge of visualizing invisible data.
                             </p>
                        </div>
                    </Link>
                    ...
                    >
                         <div className="relative z-10">
                             <span className="block text-white font-mono text-md uppercase tracking-widest mb-2 group-hover/item:text-black transition-colors">[The Tech]</span>
                             <h3 className="font-[n27] text-5xl text-white mb-1 group-hover/item:text-[#ff9a65] transition-colors pt-20">Methodology</h3>
                             <p className="text-white/40 text-xs font-mono leading-relaxed group-hover/item:text-black transition-colors">
                                Deep dive into data collection, normalization, and our stack.
                             </p>
                        </div>
                    </Link>
                     ...
                     >
                         <div className="relative z-10">
                             <span className="block text-white font-mono text-md uppercase tracking-widest mb-2 group-hover/item:text-black transition-colors">[The People]</span>
                             <h3 className="font-[n27] text-5xl text-white mb-1 group-hover/item:text-[#ff9a65] transition-colors pt-20">Team</h3>
                             <p className="text-white/40 text-xs font-mono leading-relaxed group-hover/item:text-black transition-colors">
                                Meet the students behind the Open Data Analysis initiative.
                             </p>
                        </div>
                    </Link>
                  </>
               ...
               {activeMenu === 'sources' && (
                   <>
                    ...
                    >
                        <div className="relative z-10">
                             <span className="block text-white font-mono text-md uppercase tracking-widest mb-2 group-hover/item:text-black transition-colors">[Data Origin]</span>
                             <h3 className="font-[n27] text-5xl text-white mb-1 group-hover/item:text-[#ff9a65] transition-colors pt-20">Sources</h3>
                             <p className="text-white/40 text-xs font-mono leading-relaxed group-hover/item:text-black transition-colors">
                                Detailed documentation of UCDP, ACLED, and NGO incident data.
                             </p>
                        </div>
                    </Link>
                     ...
                     >
                         <div className="relative z-10">
                             <span className="block text-white font-mono text-md uppercase tracking-widest mb-2 group-hover/item:text-black transition-colors">[Legal]</span>
                             <h3 className="font-[n27] text-5xl text-white mb-1 group-hover/item:text-[#ff9a65] transition-colors pt-20">Impressum</h3>
                             <p className="text-white/40 text-xs font-mono leading-relaxed group-hover/item:text-black transition-colors">
                    ...
                    >
                         <div className="relative z-10">
                             <span className="block text-white font-mono text-md uppercase tracking-widest mb-2 group-hover/item:text-black transition-colors">[Codebase]</span>
                             <h3 className="font-[n27] text-5xl text-white mb-1 group-hover/item:text-[#ff9a65] transition-colors pt-20">GitHub</h3>
                             <p className="text-white/40 text-xs font-mono leading-relaxed group-hover/item:text-black transition-colors">

...
export default function ScrollToTopButton({ containerRef, threshold = 500 }: ScrollToTopButtonProps) {
  ...
  return (
    ...
    >
      ...
      >
          ...
          {/* Tooltip on hover */}
          <span className="absolute right-full mr-4 bg-black/80 backdrop-blur border border-white/10 px-3 py-1.5 text-xs font-mono text-white/70 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
              RETURN TO TOP
          </span>
      </button>
    </div>
